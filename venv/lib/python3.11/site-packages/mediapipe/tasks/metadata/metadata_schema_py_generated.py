...
class ImagePropertiesT(object):
    ...
    def __init__(
        ...
        self.colorSpace = colorSpace  # type: int
        self.defaultSize = defaultSize  # type: Optional[ImageSizeT]
...
class BoundingBoxPropertiesT(object):
    ...
    def __init__(
        ...
        self.index = index  # type: Optional[List[int]]
        self.type = type  # type: int
        self.coordinateType = coordinateType  # type: int
...
class ContentT(object):
    ...
    def __init__(
        self,
        contentPropertiesType = 0,
        contentProperties = None,
        range = None,
    ):
        self.contentPropertiesType = contentPropertiesType  # type: int
        self.contentProperties = contentProperties  # type: Union[None, 'FeaturePropertiesT', 'ImagePropertiesT', 'BoundingBoxPropertiesT', 'AudioPropertiesT']
        self.range = range  # type: Optional[ValueRangeT]
...
class NormalizationOptionsT(object):
    ...
    def __init__(
        ...
        self.std = std  # type: Optional[List[float]]
...
class ScoreCalibrationOptionsT(object):
    ...
    def __init__(
        self,
        scoreTransformation = 0,
        defaultScore = 0.0,
    ):
        self.scoreTransformation = scoreTransformation  # type: int
        self.defaultScore = defaultScore  # type: float
...
class ScoreThresholdingOptionsT(object):
    ...
    def __init__(
        self,
        globalScoreThreshold = 0.0,
    ):
        self.globalScoreThreshold = globalScoreThreshold  # type: float
...
class BertTokenizerOptionsT(object):
    ...
    def __init__(
        ...
        self.vocabFile = vocabFile  # type: Optional[List[AssociatedFileT]]
...
class SentencePieceTokenizerOptionsT(object):
    ...
    def __init__(
        ...
        self.sentencePieceModel = sentencePieceModel  # type: Optional[List[AssociatedFileT]]
        self.vocabFile = vocabFile  # type: Optional[List[AssociatedFileT]]
...
class RegexTokenizerOptionsT(object):
    ...
    def __init__(
        self,
        delimRegexPattern = None,
        vocabFile = None,
    ):
        self.delimRegexPattern = delimRegexPattern  # type: Optional[str]
        self.vocabFile = vocabFile  # type: Optional[List[AssociatedFileT]]
...
class ProcessUnitT(object):
    ...
    def __init__(
        ...
        self.optionsType = optionsType  # type: int
        self.options = options  # type: Union[None, 'NormalizationOptionsT', 'ScoreCalibrationOptionsT', 'ScoreThresholdingOptionsT', 'BertTokenizerOptionsT', 'SentencePieceTokenizerOptionsT', 'RegexTokenizerOptionsT']
...
class TensorGroupT(object):
    ...
    def __init__(
        ...
        self.name = name  # type: Optional[str]
        self.tensorNames = tensorNames  # type: Optional[List[Optional[str]]]
...
class TensorMetadataT(object):
    ...
    def __init__(
        ...
        self.name = name  # type: Optional[str]
        self.description = description  # type: Optional[str]
        self.dimensionNames = dimensionNames  # type: Optional[List[Optional[str]]]
        self.content = content  # type: Optional[ContentT]
        self.processUnits = processUnits  # type: Optional[List[ProcessUnitT]]
        self.stats = stats  # type: Optional[StatsT]
        self.associatedFiles = associatedFiles  # type: Optional[List[AssociatedFileT]]
...
class SubGraphMetadataT(object):
    ...
    def __init__(
        ...
        associatedFiles = None,
        inputProcessUnits = None,
        outputProcessUnits = None,
        inputTensorGroups = None,
        outputTensorGroups = None,
        customMetadata = None,
    ):
        self.name = name  # type: Optional[str]
        self.description = description  # type: Optional[str]
        self.inputTensorMetadata = inputTensorMetadata  # type: Optional[List[TensorMetadataT]]
        self.outputTensorMetadata = outputTensorMetadata  # type: Optional[List[TensorMetadataT]]
        self.associatedFiles = associatedFiles  # type: Optional[List[AssociatedFileT]]
        self.inputProcessUnits = inputProcessUnits  # type: Optional[List[ProcessUnitT]]
        self.outputProcessUnits = outputProcessUnits  # type: Optional[List[ProcessUnitT]]
        self.inputTensorGroups = inputTensorGroups  # type: Optional[List[TensorGroupT]]
        self.outputTensorGroups = outputTensorGroups  # type: Optional[List[TensorGroupT]]
        self.customMetadata = customMetadata  # type: Optional[List[CustomMetadataT]]
...
class ModelMetadataT(object):
    ...
    def __init__(
        ...
        license = None,
        associatedFiles = None,
        minParserVersion = None,
    ):
        self.name = name  # type: Optional[str]
        self.description = description  # type: Optional[str]
        self.version = version  # type: Optional[str]
        self.subgraphMetadata = subgraphMetadata  # type: Optional[List[SubGraphMetadataT]]
        self.author = author  # type: Optional[str]
        self.license = license  # type: Optional[str]
        self.associatedFiles = associatedFiles  # type: Optional[List[AssociatedFileT]]
        self.minParserVersion = minParserVersion  # type: Optional[str]
