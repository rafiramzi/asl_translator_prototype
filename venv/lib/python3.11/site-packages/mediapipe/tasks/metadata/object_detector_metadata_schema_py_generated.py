...
class FixedAnchorT(object):
    ...
    def __init__(
        ...
        self.xCenter = xCenter  # type: float
        self.yCenter = yCenter  # type: float
...
class FixedAnchorsSchemaT(object):
    ...
    def __init__(
        ...
        self.anchors = anchors  # type: Optional[List[FixedAnchorT]]
...
class SsdAnchorsOptionsT(object):
    ...
    def __init__(
        self,
        fixedAnchorsSchema = None,
    ):
        self.fixedAnchorsSchema = fixedAnchorsSchema  # type: Optional[FixedAnchorsSchemaT]
...
class TensorsDecodingOptionsT(object):
    ...
    def __init__(
        ...
        self.numClasses = numClasses  # type: int
        self.numBoxes = numBoxes  # type: int
        self.numCoords = numCoords  # type: int
        self.keypointCoordOffset = keypointCoordOffset  # type: int
        self.numKeypoints = numKeypoints  # type: int
        self.numValuesPerKeypoint = numValuesPerKeypoint  # type: int
        self.xScale = xScale  # type: float
        self.yScale = yScale  # type: float
        self.wScale = wScale  # type: float
        self.hScale = hScale  # type: float
        self.applyExponentialOnBoxSize = applyExponentialOnBoxSize  # type: bool
        self.sigmoidScore = sigmoidScore  # type: bool
...
class ObjectDetectorOptionsT(object):
    ...
    def __init__(
        ...
        ssdAnchorsOptions = None,
        tensorsDecodingOptions = None,
    ):
        self.minParserVersion = minParserVersion  # type: Optional[str]
        self.ssdAnchorsOptions = ssdAnchorsOptions  # type: Optional[SsdAnchorsOptionsT]
        self.tensorsDecodingOptions = tensorsDecodingOptions  # type: Optional[TensorsDecodingOptionsT]
